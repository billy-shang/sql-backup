...
class NotifyConfig(Base):
    ...
    dingtalk_webhook: Mapped[str] = mapped_column(String(1024), nullable=False, default="")
    notify_channel: Mapped[str] = mapped_column(String(64), nullable=False, default="feishu")
